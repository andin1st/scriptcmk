...
Anda tidak perlu mengonfigurasi ulang komputer client satu per satu.
Cukup lakukan perubahan pada berkas script yang ada di dalam repositori GitHub ini dan lakukan commit/push.
Pada komputer client yang sudah aktif, jalankan kembali perintah one-liner bootstrap di atas untuk memperbarui script lokal mereka ke versi terbaru secara otomatis.
